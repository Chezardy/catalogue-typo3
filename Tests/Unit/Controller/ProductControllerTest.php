...
/**
 * Test case for class Brawh\CatalogueBrawh\Controller\ProductController.
 *
...
class ProductControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Brawh\CatalogueBrawh\Controller\ProductController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Brawh\\CatalogueBrawh\\Controller\\ProductController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllProductsFromRepositoryAndAssignsThemToView()
	{
		...
		$productRepository = $this->getMock('Brawh\\CatalogueBrawh\\Domain\\Repository\\ProductRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$product = new \Brawh\CatalogueBrawh\Domain\Model\Product();

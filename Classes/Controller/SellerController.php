...
class SellerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * sellerRepository
     *
     * @var \Brawh\CatalogueBrawh\Domain\Repository\SellerRepository
     * @inject
     */
     ...
     * @return void
     */
    public function showAction(\Brawh\CatalogueBrawh\Domain\Model\Seller $seller)
    {
        $this->view->assign('seller', $seller);
    }
